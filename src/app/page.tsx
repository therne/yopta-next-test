      ...
      <section className="grid items-center gap-6 pt-6 pb-8 md:py-10">
        <div className="flex max-w-[980px] flex-col items-start gap-2">
          ...
          <p className="max-w-[750px] text-lg text-slate-700 dark:text-slate-400 sm:text-xl">
            ...
            <span className="font-semibold">Use this to build your own component library</span>.
          </p>
        </div>
        <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 md:flex-row">
          ...
          <Link
            ...
            className={cn(buttonVariants({ variant: 'outline', size: 'lg' }), 'md:hidden')}
          >
            GitHub
          </Link>
        ...
        <div>
          <p className="text-sm text-slate-500 dark:text-slate-400">
            ...
            <Link href={siteConfig.links.twitter} className="font-medium underline underline-offset-4">
              Twitter
            </Link>
            .
          </p>
